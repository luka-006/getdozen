...
| `npx tsx scripts/generate-launch-video.ts` | 9:16 launch video from prod (needs auth) |
| `npx tsx scripts/send-waitlist-launch.ts --dry-run` | Preview launch email to confirmed waitlist |
| `marketing/launch/social-posts.md` | Ready-to-post copy (X, LinkedIn, PH, HN) |
| `marketing/launch/launch-checklist.md` | Pre-launch verification list |
